...
public class a implements aa {
    ...
    private WeakReference<com.b.a.b.aa.b> f = null;

    private byte[] g = null;

    private CRC32 h = new CRC32();

    public a(com.b.a.b.aa.b paramb) {
    ...
    private int a(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, int paramInt) {
        int paramInt1 = (paramArrayOfbyte2 == null) ? 0 : paramArrayOfbyte2.length;
        paramInt = com.b.a.a.a.a.a.a(paramArrayOfbyte1, paramInt1, paramInt);
        if (paramInt1 != 0)
    ...
    private int a(byte[] paramArrayOfbyte, Collection<byte[]> paramCollection, int paramInt) {
        int paramInt1 = (paramCollection == null) ? 0 : paramCollection.size();
        paramInt = com.b.a.a.a.a.a.a(paramArrayOfbyte, paramInt1, paramInt);
        if (paramInt1 != 0)
