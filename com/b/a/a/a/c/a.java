...
public class a implements aa {
    ...
    public static void a(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3,
            int paramInt2, int paramInt3, int paramInt4) {
        int i = paramArrayOfbyte3.length;
        int j = paramInt2 % i;
        int k = paramInt2;
        for (byte b = 0; b < paramInt4; b++) {
            paramArrayOfbyte1[paramInt1++] = (byte) (paramArrayOfbyte2[paramInt3++] ^ paramArrayOfbyte3[j]
